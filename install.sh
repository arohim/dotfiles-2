...
# brew install --cask firebase-emulator        # Firebase local emulator - UNAVAILABLE

# Install KMM development tools
echo "📱 Installing KMM development tools..."
# brew install --cask kotlin                   # Kotlin compiler - UNAVAILABLE
...
python3 -m pip install --user --break-system-packages requests beautifulsoup4 pandas numpy matplotlib jupyter
...
python3 -m pip install --user --break-system-packages androguard apkleaks
# pip3 install apktool             # APK manipulation - NOT AVAILABLE
...
python3 -m pip install --user --break-system-packages firebase-admin google-cloud-storage google-auth requests-oauthlib
